...
e.preventDefault();
try {
  const res = await axios.post("http://localhost:8000/api/v1/user/register",{name,email,password,phone,address});
...
console.log()
 ...
 <form onSubmit={handleSubmit}>
  ...
  <div className="mb-3">
    ...
    className="form-control" id="exampleInputPhone" placeholder='enter your phone number' />
  </div>
  <div className="mb-3">
